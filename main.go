...
<body class="antialiased">
    <div id="app" class="min-h-screen flex flex-col items-center justify-center p-4">
        <div class="max-w-2xl w-full floating-card">
			...
			<br>
            <div class="fixed bottom-4 inset-x-0 flex justify-center space-x-4 text-gray-400">
                <a href="https://github.com/yourusername/url-shortener" target="_blank" class="github-link flex items-center space-x-2 px-4 py-2 rounded-lg bg-gray-800/50 backdrop-blur-sm">
